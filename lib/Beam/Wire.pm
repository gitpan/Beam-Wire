...
$Beam::Wire::Exception::VERSION = '1.006';
use Moo;
with 'Throwable';


package Beam::Wire::Exception::Service;
$Beam::Wire::Exception::Service::VERSION = '1.006';
use Moo;
use MooX::Types::MooseLike::Base qw( :all );
...
$Beam::Wire::Exception::NotFound::VERSION = '1.006';
use Moo;
extends 'Beam::Wire::Exception::Service';


package Beam::Wire::Exception::InvalidConfig;
$Beam::Wire::Exception::InvalidConfig::VERSION = '1.006';
use Moo;
extends 'Beam::Wire::Exception::Service';
